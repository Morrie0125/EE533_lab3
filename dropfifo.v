...
// /___/   /\     Timestamp : 01/28/2025 16:56:10
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family virtex2p -w "C:/Documents and Settings/student/ip_core/ipcore/dropfifo.sch" dropfifo.vf
...
module dropfifo(clk, 
   ...
   OR2 XLXI_8 (.I0(XLXN_10), 
               .I1(XLXN_9), 
               .O(XLXN_11));
   AND2B1 XLXI_9 (.I0(XLXN_12), 
                  .I1(XLXN_11), 
                  .O(XLXN_17));
   AND3B2 XLXI_10 (.I0(XLXN_23), 
                   .I1(XLXN_22), 
                   .I2(fiforead), 
                   .O(XLXN_26));
   reg9B XLXI_11 (.ce(XLXN_32), 
                  .clk(clk), 
                  .clr(rst), 
                  .d(in_fifo[71:0]), 
                  .q(in_fifo0[71:0]));
   ...
   dual_port_memory XLXI_15 (.addra(waddr[7:0]), 
                             .addrb(raddr[7:0]), 
                             .clka(clk), 
                             .clkb(clk), 
                             .dina(in_fifo0[71:0]), 
